      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Center(
              child: HugeIcon(icon: AppIcons.bookmark, color: AppColors.primaryPurpleDark),
            ),
          ),
          ...
          Container(
            ...
            child: Text(
              progress,
              style: AppTextStyles.bodySmall.copyWith(color: AppColors.orange, fontWeight: FontWeight.bold),
            ),
          ),
        ],
      ),
