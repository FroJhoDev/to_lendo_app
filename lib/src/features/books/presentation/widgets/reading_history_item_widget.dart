...
class ReadingHistoryItemWidget extends StatelessWidget {
  ...
  const ReadingHistoryItemWidget({super.key, required this.action, required this.date, this.duration});
      ...
      child: Row(
        children: [
          Container(
            width: 48,
            height: 48,
            decoration: const BoxDecoration(color: AppColors.lightLavenderAlt, shape: BoxShape.circle),
            child: const Center(
              child: HugeIcon(icon: AppIcons.bookOutlined, color: AppColors.primaryPurpleDark),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(action, style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
